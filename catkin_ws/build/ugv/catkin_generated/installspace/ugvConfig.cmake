...
if("FALSE" STREQUAL "TRUE")
  set(ugv_SOURCE_PREFIX /home/naveen/catkin_ws/src/ugv)
  set(ugv_DEVEL_PREFIX /home/naveen/catkin_ws/devel)
  set(ugv_INSTALL_PREFIX "")
  set(ugv_PREFIX ${ugv_DEVEL_PREFIX})
else()
  set(ugv_SOURCE_PREFIX "")
  set(ugv_DEVEL_PREFIX "")
  set(ugv_INSTALL_PREFIX /home/naveen/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'naveen <naveen@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ugv' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/naveen/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/naveen/catkin_ws/install/lib;/opt/ros/melodic/lib)
